    ...
    <div
        ...
        @auth
            @if (auth()->user()->role->value === 1)
                ...
                onclick="activateNavItem(this)" style="transition: background-color 0.2s; background-color: #F41E1E;">
                <i class="fas fa-th-large text-black dark:text-white text-xl"></i>
                <!-- Dashboard Icon (Four Squares Block) -->
            </a>
            @else
                <a href="/user" class="nav-item flex items-center justify-center w-12 h-12 rounded-full cursor-pointer active"
                onclick="activateNavItem(this)" style="transition: background-color 0.2s; background-color: #F41E1E;">
                <i class="fas fa-th-large text-black dark:text-white text-xl"></i>
                <!-- Dashboard Icon (Four Squares Block) -->
            </a>
        ...
        @else
            <a href="/register"
                class="nav-item flex items-center justify-center w-12 h-12 rounded-full cursor-pointer active"
                onclick="activateNavItem(this)" style="transition: background-color 0.2s; background-color: #F41E1E;">
                <i class="fas fa-th-large text-black dark:text-white text-xl"></i>
        ...
        <a href="{{ url('/cart') }}"
            ...
            onclick="activateNavItem(this)" style="transition: background-color 0.2s;">
        ...
        <a href="/user/profile" class="nav-item flex items-center justify-center w-12 h-12 rounded-full cursor-pointer"
            onclick="activateNavItem(this)" style="transition: background-color 0.2s;">
