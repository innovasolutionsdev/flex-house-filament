<footer id="view-footer" class="w-full bg-[#141414] border-t border-gray-900" style="display: none;">
    <div class=" mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div
            ...
            <!--End Col-->
            <div class="lg:mx-auto text-left pl-6 sm:pl-0">
            ...
            <div class="lg:mx-auto text-left">
                ...
                <p class="text-md text-gray-400 leading-6 mb-7">
                    Subscribe to get the latest offers from us
                </p>
        ...
        <div class="py-7 border-t border-gray-700">
            <div class="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                <span class="text-sm text-gray-400">
                    ©
                    <a class="text-gray-400 hover:text-white" href="https://pagedone.io/">
                        pagedone
                    </a>
