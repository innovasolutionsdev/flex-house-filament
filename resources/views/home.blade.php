                ...
                <div class="col-lg-8">
                    <div class="hero-text">
                        ...
                        <button type="button"
                                ...
                                class="text-white  hover:bg-black focus:ring-4 focus:ring-blue-300 font-medium  text-md px-5 py-2.5 me-2 mb-2  focus:outline-none ">Register
                            Now</button>
                ...
                <div class="col-lg-6">
                    <div class="about-text">
                        ...
                        <a href="#" class="primary-btn">Learn More</a>
                                                                    ...
                                                                    <div class="w-full flex-col justify-center items-start gap-8 flex">
                                                                        <div class="flex-col justify-start lg:items-start items-center gap-4 flex">
                                                                            ...
                                                                            <div class="w-full flex-col justify-start lg:items-start items-center gap-3 flex">
                                                                                <h2  style="color: #1D2229" class=" text-4xl font-extrabold font-manrope leading-normal lg:text-start text-center">
                                                                        ...
                                                                        <div class="w-full flex-col justify-center items-start gap-6 flex">
                                                                            <div class="w-full justify-start items-center gap-8 grid md:grid-cols-2 grid-cols-1">
                                                                                <div
                                                                                    ...
                                                                                    <h4 class="text-gray-900 text-2xl font-extrabold font-manrope leading-9">33+ Years</h4>
                                                                                    <p class="text-gray-500 text-base font-normal leading-relaxed">Influencing Digital
                                                                                        Landscapes Together</p>
                                                                                </div>
                                                                                <div
                                                                                    class="w-full h-full p-3.5 rounded-xl border border-gray-200 hover:border-gray-400 transition-all duration-700 ease-in-out flex-col justify-start items-start gap-2.5 inline-flex hover:bg-gray-200 hover:shadow-lg bg-gray-100">
                                                                                    <h4 class="text-gray-900 text-2xl font-extrabold font-manrope leading-9">125+ Projects
                                                                                    </h4>
                                                                            ...
                                                                            <div class="w-full h-full justify-start items-center gap-8 grid md:grid-cols-2 grid-cols-1">
                                                                                <div
                                                                                    ...
                                                                                    <h4 class="text-gray-900 text-2xl font-extrabold font-manrope leading-9">26+ Awards</h4>
                                                                                    <p class="text-gray-500 text-base font-normal leading-relaxed">Our Dedication to
                                                                                        Innovation Wins Understanding</p>
                                                                                </div>
                                                                                <div
                                                                                    class="w-full h-full p-3.5 rounded-xl border border-gray-200 hover:border-gray-400 transition-all duration-700 ease-in-out flex-col justify-start items-start gap-2.5 inline-flex hover:bg-gray-200 hover:shadow-lg bg-gray-100">
                                                                                    <h4 class="text-gray-900 text-2xl font-extrabold font-manrope leading-9">99% Happy Clients</h4>
                                                                                    <p class="text-gray-500 text-base font-normal leading-relaxed">Mirrors our Focus on Client Satisfaction.</p>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                ...
                                class="text-white   focus:ring-4 focus:ring-blue-300 font-medium  text-md px-5 py-2.5 me-2 mb-2  focus:outline-none rounded-sm ">Learn More</button>
...
<section class="py-24 relative xl:mr-0 lg:mr-5 mr-0" style="background-color: #141414">
    <div class="w-full max-w-7xl px-4 md:px-5 lg:px-5 mx-auto">
        <div class="w-full justify-start items-center xl:gap-12 gap-10 grid lg:grid-cols-2 grid-cols-1 lg:grid-flow-col-dense">
            ...
            <div class="w-full flex-col justify-center lg:items-start items-center gap-10 inline-flex">
                <div class="w-full flex-col justify-center items-start gap-8 flex">
                    <div class="flex-col justify-start lg:items-start items-center gap-4 flex">
                        <h4 class="font-bold leading-relaxed" style="color: #F41E1E">About Us</h6>
                        <div class="w-full flex-col justify-start lg:items-start items-center gap-3 flex">
                            <h2 style="color: white" class="text-4xl font-extrabold font-manrope leading-normal lg:text-start text-center">
                                The Tale of Our Achievement Story</h2>
...
{{-- <div class="w-full pl-5 pr-5 py-20 px-10 lg:py-16 lg:px-6" style="background-color: #141414">
    ...
    <section class="membership-section spad  ">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4">
    <div class="membership-item rounded-2xl shadow-lg transition-transform transform hover:scale-105 hover:shadow-2xl" >
        ...
        <p class="text-gray-600 text-md px-4 py-2">
            Enjoy 1 month of full access to all our gym facilities, personal trainers, and classes. Ideal for short-term fitness goals!
        </p>
       ...
       <button type="button"
                                ...
                                class="text-white bg-black hover:bg-red-600 focus:ring-4 focus:ring-blue-300 font-medium  text-md px-5 py-2.5 me-2 mb-2  focus:outline-none ">Register
                            Now</button>
    </div>
</div>
...
<div class="font-[manrope] my-4 pt-10 pb-20" style="background-color: #141414">
            <div class="max-w-5xl max-lg:max-w-2xl mx-auto">
                <div class="max-w-2xl mx-auto text-center">
                    <h2 class="text-white text-4xl font-extrabold font-manrope leading-normal lg:text-start text-center">Meet our team</h2>
                    <p class="text-gray-400 text-sm mt-4 leading-relaxed">Veniam proident aute magna anim excepteur et ex consectetur velit ullamco veniam minim aute sit. Ullamco nisi enim ipsum irure laboris ad ut. Esse cupidatat deserunt magna aute.</p>
                </div>

                <div class="grid lg:grid-cols-3 md:grid-cols-2 gap-8 max-md:justify-center mt-12">
                    <div class="border rounded-xl overflow-hidden max-md:max-w-[300px] transition-transform transform hover:scale-105">
                        <img src="https://readymadeui.com/team-1.webp" class="w-full h-60 object-contain object-top bg-gray-200" />
                        ...
                        <div class="p-4 bg-white">
                            ...
                            <div class="mt-4">
                                <p class="text-gray-600 text-md leading-relaxed">Eiusmod commodo aliquip laboris qui anim non voluptate consectetur.</p>
                            </div>
                    ...
                    <div class="border rounded-md overflow-hidden max-md:max-w-[300px] transition-transform transform hover:scale-105">
                        <img src="https://readymadeui.com/team-2.webp" class="w-full h-60 object-contain object-top bg-gray-200" />
    ...
    <section class="text-gray-600 body-font ">
        <div class="container px-5 py-24 mx-auto">
            <div class="flex flex-col text-center w-full mb-20">
                ...
                <p class="lg:w-2/3 mx-auto leading-relaxed text-gray-500">Explore our state-of-the-art facility and get a glimpse of the transformations happening every day. From weightlifting
                    to cardio sessions, and personalized coaching to group classes, each moment captured showcases the dedication, strength,
                    and motivation of our members. Scroll through to see how we're helping individuals achieve their fitness goals and
                    beyond.</p>
            </div>
            <div class="flex flex-wrap -m-4">
                <div class="lg:w-1/3 sm:w-1/2 p-4 rounded-md">
                    <div class="flex relative rounded-md">
                        <img alt="gallery" class="absolute inset-0 w-full rounded-xl h-full object-cover object-center shadow-md"
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="banner-text">
                        <h2 class="text-4xl font-extrabold font-manrope leading-normal lg:text-start">Start Your Fitness Journey Today</h2>
                        <p>Unlock your full potential with personalized training programs designed to help you reach your goals. Let’s make
                            progress, together.</p>
                       <button type="button"
    style="background-color: #F41E1E; "
...
{{--    <!-- Testimonial Section End -->--}}
    ...
    <div>
        ...
        <p class="text-md text-gray-500 mt-4 leading-relaxed">Have a specific inquiry or looking to explore new opportunities? Our
    ...
    <section class="latest-blog-section spad" style="background-color: #1e1e1e;">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
                        <h4 class="text-white text-4xl font-extrabold font-manrope leading-normal lg:text-start">Latest Blog</h2>
                    </div>
                </div>
            </div>
            <div class="row">
               ...
               <div class="col-lg-4 col-md-6">
    <div class="single-blog-item bg-gray-200 rounded-lg shadow-lg transition-transform transform hover:scale-105 hover:bg-gray-100 p-4">
        ...
        <h4 class="text-white mt-4">
            <a href="#" class="text-black hover:underline">10 States At Risk of Rural Hospital Closures</a>
        </h4>
        <p class="text-gray-500 mt-2 line-clamp-2">
            Many rural hospitals are at risk of closure due to financial strain. This article discusses the states most affected by these closures.
        </p>
    </div>
</div>
