        ...
        <div class="w-full lg:w-3/4 lg:ml-9">
            <div class="flex flex-col lg:flex-row justify-between items-center mb-4">
                ...
                <div class="relative w-2/3 lg:w-auto">
                    <input class="border border-gray-300 p-2 rounded-lg w-full lg:w-64" placeholder="Search..."
                        type="text" />
            ...
            <p class="mb-4">
                Shop the best Protein Supplements in Sri Lanka to suit your Fitness goal! Variety of Proteins available
                from Pure isolates, Blends &amp; Vegan Proteins.
            </p>
            <div class="flex justify-between items-center mb-4">
                ...
                <button class="lg:hidden bg-[#F41E1E] text-white p-2 rounded-lg hover:bg-gray-900"
...
{{--            </button> --}}
{{--            <div class="bg-white p-4 shadow-md rounded-lg"> --}}
{{--                <h2 class="text-xl font-bold border-b-2 border-[#F41E1E] pb-2 mb-4"> --}}
{{--                    Categories --}}
{{--                </h2> --}}
{{--                <ul class="space-y-2"> --}}
{{--                    <li> --}}
