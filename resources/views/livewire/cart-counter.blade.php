<a href="{{ route('cart') }}" class="relative text-gray-600 hover:text-gray-800 bg-[#141414]">
...
{{--    </svg>--}}
    ...
    <i class="fa-solid fa-cart-shopping relative text-white   text-2xl"></i>

    <!-- Notification Badge -->
    <span class="absolute top-0 right-0 bg-red-600 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center transform translate-x-2/3 -translate-y-2/3">
        {{ $cart_counter }}
    </span>
</a>
