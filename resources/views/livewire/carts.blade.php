...
<div class="container mx-auto p-4">
    <div class="flex flex-col lg:flex-row bg-white rounded-lg shadow-lg">
     ...
     <div class="w-full lg:w-2/3 p-6">
      ...
      <!-- Cart Items -->
      <div class="py-4">
       <div class="flex flex-col md:flex-row items-center justify-between py-4 border-b border-gray-300">
        ...
        <div class="flex flex-col md:flex-row items-center justify-between w-full md:w-3/4">
         ...
         <div class="flex items-center md:ml-4">
          ...
          <button class="ml-8 text-gray-600">
       ...
       <div class="flex flex-col md:flex-row items-center justify-between py-4 border-b border-gray-300">
        <div class="flex items-center mb-4 md:mb-0 md:w-1/4">
         <img alt="Light gray T-shirt" class="w-16 h-16 mr-4" src="https://placehold.co/60x60"/>
        </div>
        <div class="flex flex-col md:flex-row items-center justify-between w-full md:w-3/4">
         <div class="flex flex-col items-start mb-4 md:mb-0 md:ml-4">
          <p class="text-gray-600">
       ...
       <div class="flex flex-col md:flex-row items-center justify-between py-4 border-b border-gray-300">
        <div class="flex items-center mb-4 md:mb-0 md:w-1/4">
         <img alt="Black T-shirt" class="w-16 h-16 mr-4" src="https://placehold.co/60x60"/>
        </div>
        <div class="flex flex-col md:flex-row items-center justify-between w-full md:w-3/4">
         <div class="flex flex-col items-start mb-4 md:mb-0 md:ml-4">
          <p class="text-gray-600">
     ...
     <div class="w-full lg:w-1/3 bg-gray-100 p-6 rounded-r-lg">
      ...
      <div class="mb-4">
       <label class="block text-gray-600 mb-2" for="shipping">
        SHIPPING
       </label>
      ...
      <div class="mb-4">
       <label class="block text-gray-600 mb-2" for="code">
        GIVE CODE
       </label>
       <div class="flex">
      ...
      <button class="w-full p-3 bg-black text-white font-bold rounded checkout-button">
       CHECKOUT
      </button>
     </div>
    </div>
